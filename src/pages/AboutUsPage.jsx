...
const HERO_BG = '/image/julianna-corbett-R3IYAFLDX0I-unsplash (1).webp'; // Community youth
const MISSION_IMG = '/image/damian-patkowski-T-LfvX-7IVg-unsplash.webp'; // Collaborative engagement
const ORIGIN_IMG = '/image/founder.webp'; // Founder image
    ...
    <div className="bg-surface">
      ...
      <header className="relative min-h-[90vh] flex items-center overflow-hidden -mt-20">
        <div className="absolute inset-0 z-0">
          <img src={HERO_BG} alt="Ghanaian youth" className="w-full h-full object-cover hero-img-ken-burns scale-110" loading="eager" fetchPriority="high" />
      ...
      {/* BELIEFS SECTION */}
      <section id="role" className="py-32 px-8 bg-primary">
      ...
      <section id="fact-sheet" className="py-32 px-8 bg-surface-container-lowest border-y border-outline-variant/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div id="financials" className="mt-20 p-12 bg-primary rounded-3xl grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
      ...
      {/* ORIGIN STORY */}
      <section id="story" className="py-24 px-8 bg-surface-container-low/30">
        <div className="max-w-7xl mx-auto">
